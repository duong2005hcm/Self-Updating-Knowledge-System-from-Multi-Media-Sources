...
export default function ImageGeneratorPage() {
  ...
  const handleGenerate = async () => {
    ...
    const finalPrompt = `${prompt}, style ${style}, quality ${quality}, highly detailed, cinematic lighting`;
        ...
        <div className="ig-header">
          ...
          <div>
            ...
            <p className="ig-header-sub">
              Mô tả hình ảnh bạn muốn, AI sẽ tạo cho bạn trong vài giây.
            </p>
          </div>
        </div>
