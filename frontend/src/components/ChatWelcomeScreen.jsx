...
const SUGGESTIONS = [
  ...
  },
  {
    ...
    title: "Tạo nội dung",
    desc: "Tạo ý tưởng, nội dung sáng tạo, marketing",
    prompt: "Hãy giúp tôi tạo nội dung marketing cho",
  },
  {
    icon: <IconCode size={24} color="#7c3aed" />,
    title: "Hỗ trợ code",
    desc: "Viết code, debug, giải thích thuật toán",
    prompt: "Hãy giúp tôi viết code cho",
  },
];
