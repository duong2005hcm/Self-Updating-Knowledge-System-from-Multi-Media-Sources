  ...
  return (
    <section className="page-shell py-12">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <SectionHeading
          kicker="Bộ Y tế"
          title="Tin nổi bật từ Bộ Y tế"
          description="Landing page chỉ hiển thị bài public từ `GET /api/articles/latest?source_name=Bộ Y tế&limit=6`."
        />
        {usingFallback ? (
      ...
      {!isLoading && !error && !hasArticles ? (
        <div className="mt-10">
          <EmptyState
            ...
            message="Backend articles API đang hoạt động nhưng chưa có bài Bộ Y tế public với status published, approved hoặc active."
          />
        </div>
      ) : null}
