...
import ImageGenerator from "../components/ImageGenerator";   // ← Đã thêm import
import {
  computeTitle,
  lastPreview,
  loadConversations,
...
export default function ChatLayout({ user, onLogout }) {
  ...
  const handleNewImageChat = () => {
    ...
    setChatState((prev) => ({
      conversations: [imageChat, ...prev.conversations],
      activeConversationId: imageChat.id,
    }));
  ...
  return (
    <div className="app-root">
      ...
      <Sidebar
        ...
        onNewImageChat={handleNewImageChat}        /* ← Đã thêm */
      ...
      <div className="main-area">
        ...
        <div className="chat-body">
          ...
          {tool === "image-gen" && (
            <ImageGenerator conversationId={activeConversationId} />
          )}
        ...
        {/* Chỉ hiện ChatInput khi đang ở chế độ chat thông thường */}
        {tool === "chat" && <ChatInput setMessages={setActiveMessages} />}
      </div>
    </div>
  );
}